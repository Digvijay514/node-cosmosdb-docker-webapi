...
## Running this starter application
...
1. Clone this repository using `git clone https://github.com/Digvijay514/node-cosmosdb-docker-webapi.git`

1. Change directories to the repo using `cd node-cosmosdb-docker-webapi`
...
1. Run `node app.js` in a terminal to start your start your node application. Alternatively run `npm run dev` to start the application in a development environment.
